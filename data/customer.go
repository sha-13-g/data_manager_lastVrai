...
func (customer Customer) Add() sql.Result {
	...
	query := fmt.Sprintf(`INSERT INTO customer VALUES ($1, $2, $3, $4, $5, $6, $7)`)
	r, err := db.Exec(query, &customer.Id, &customer.Logo, &customer.Name, &customer.Address, &customer.Contact, &customer.Branch, &customer.Commercial_id)
	checkIfError(err)
